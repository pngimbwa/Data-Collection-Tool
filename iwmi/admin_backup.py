...
class RelationManagerAdmin(admin.ModelAdmin):
   # prepopulated_fields = {"slug" : ("crop_name",)}
    search_fields = ['personA','personB','relation']
    list_display = ('personA','personB','relation')
...
class FarmAdmin(admin.ModelAdmin):
   # prepopulated_fields = {"slug" : ("crop_name",)}
    search_fields = ['farmID','latitude','longitude']
    list_display = ('farmID','latitude','longitude','number','fieldsize')
...
class PlotAdmin(admin.ModelAdmin):
   # prepopulated_fields = {"slug" : ("crop_name",)}
    ...
    list_display = ('plotID','farm','village')
